...
import { addUser, tryLogin, refreshToken, updateUser, getUserData } from "./apiRequests";
...
const AuthProvider = (props) => {
    ...
    return (
        <AuthContext.Provider value={{ token, register, login, logout, getAuthHeader, modifyUserData, getUser }}>
            {props.children}
...
export const useAuthContext = () => {
    ...
    if (!context) throw new Error("AuthContext must be used within it's provider");
    return context;
};
